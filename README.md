...
## Dataset Structure
To be able to run the script, please ensure that you have a folder called images that contains the images and a folder called annotations that contains the annotations. The images and annotations can be downloaded from [mapillary.com](mapillary.com). Please make sure that you only get the fully annotated images along with the fully annotated annotations. 
